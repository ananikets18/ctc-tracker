...
export const HRA_PERCENTAGE = 0.40; // 40% of Basic Salary
export const METRO_HRA_EXEMPTION = 0.50; // 50% for metro cities
export const NON_METRO_HRA_EXEMPTION = 0.40; // 40% for non-metro cities
